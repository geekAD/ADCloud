...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
        ...
        <div class="content-box" style="width:500px;margin-top:20%; margin-left:350px;"><!-- Start Content Box -->
            ...
            <div class="clear"></div>
            <form action="insereArtigoBD.php" method="get">
            <div style="margin-left:350px;width:500px;" class="content-box-content">
                ...
                <div id="tituloArtigo" style="width:500px; margin-bottom:10px; ">
                     Titulo<input id="textoTitulo" name="textoTitulo" type="text"/>
                 </div>
                <fieldset>
                    <textarea  id="textoArtigo" name="textoArtigo" class="textarea" cols="56" rows="5"></textarea>
                </fieldset>
