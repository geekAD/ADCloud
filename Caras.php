...
<div id="wrapper"><!-- Begin Wrapper -->
    ...
    <div id="header">
            <div id="logo">
                <h1><a href="/feedJN/index.php">Portal de Feeds</a></h1>
     ...
     <div id="navigation" class="menu">
         <ul>
         <li><a href="http://geek.azurewebsites.net/index.php">Home</a>
         </li>
         <li><a href="/feedJN/JNArtigos.php?rss=http://feeds.jn.pt/JN-ULTIMAS">Jornal de Noticias</a>
         <ul>
         <li><a href="/feedJN/JNArtigos.php?rss=http://feeds.jn.pt/JN-ULTIMAS">Ultimas Notícias</a></li>
         <li><a href="/feedJN/JNArtigos.php?rss=http://feeds.jn.pt/JN-Tecnologia">Tecnologia</a></li>
         <li><a href="/feedJN/JNArtigos.php?rss=http://feeds.jn.pt/JN-Desporto"">Desporto</a></li>
         </ul>
         </li>
         <li><a href="/feedJN/DNartigos.php?rss=http://feeds.dn.pt/DN-Portugal">Diario de Noticias</a>
         <ul>
         <li><a href="/feedJN/DNartigos.php?rss=http://feeds.dn.pt/DN-Portugal">Ultimas Notícias</a></li>
         <li><a href="/feedJN/DNartigos.php?rss=http://feeds.dn.pt/DN-Desporto">Desporto</a></li>
         </ul>
         </li>
         <li><a href="/feedJN/Caras.php?rss=http://assinaturadigital.assineja.pt/Info/RSS/5">Revista Caras</a>
         </li>
         </ul>
         </div>

    
    <?php $read = new readFeedJn(); $dados = $read->getRSSJN($_GET['rss']); 
